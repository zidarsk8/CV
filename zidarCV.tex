...
\address{+386~$\cdot$~40~$\cdot$~162~$\cdot$~722 \\ zidarsk8@gmail.com} % Your phone number and email
...
\begin{rSubsection}{Faculty of computer and informations science}{Septemner2013 - ongoing}{Researcher}{San Francisco, California}
\item Research of distributed file systems and cloud computing in the Laboratory for ubiquitious systems
\end{rSubsection}
...
\item Developed the throttling control and sercurity for both client and server side code.
\end{rSubsection}
...
\item Developed smaller Delphi applications to increase efficienecy and optimize resource usage.
\end{rSubsection}
...
Computer Languages & Java, Android, Javascript, PHP, Python, Scala, Django, Bash, C, C++, \\
    Delphi & HTML, CSS \\
